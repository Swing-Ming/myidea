 ...
 * Generated at: 2016-07-25 05:52:33 UTC
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/task/../include/mainHeader.jsp", Long.valueOf(1468299514640L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                            <input type=\"hidden\"  name=\"done\" value=\"0\">\r\n");
      ...
      out.write("        <!-- /.content -->\r\n");
      out.write("\r\n");
      out.write("        <div class=\"modal fade\" id=\"taskModal\">\r\n");
      out.write("            <div class=\"modal-dialog\">\r\n");
      out.write("                <div class=\"modal-content\">\r\n");
      out.write("                    <div class=\"modal-header\">\r\n");
      out.write("                        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span\r\n");
      ...
      out.write("                    </div>\r\n");
      out.write("                    <div class=\"modal-body\">\r\n");
      out.write("                        <form id=\"taskForm\" action=\"/task/new\" method=\"post\">\r\n");
      out.write("                            <input type=\"hidden\" id=\"event_id\">\r\n");
      out.write("                            <div class=\"form-group\">\r\n");
      out.write("                                <label>待办内容</label>\r\n");
      out.write("                                <div><span id=\"event_title\"></span></div>\r\n");
      out.write("                            </div>\r\n");
      out.write("                            <div class=\"form-group\">\r\n");
      out.write("                                <label>开始时间~结束时间</label>\r\n");
      out.write("                                <div><span id=\"event_time\"></span> ~ <span id=\"event_end_time\"></span>\r\n");
      out.write("                                </div>\r\n");
      out.write("                            </div>\r\n");
      out.write("                            <div class=\"form-group\">\r\n");
      out.write("                                <label>提醒时间</label>\r\n");
      out.write("                                <div><span id=\"event_remid\"></span></div>\r\n");
      out.write("                            </div>\r\n");
      out.write("                        </form>\r\n");
      out.write("                    </div>\r\n");
      out.write("                    <div class=\"modal-footer\">\r\n");
      out.write("                        <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">取消</button>\r\n");
      out.write("                        <button type=\"button\" class=\"btn btn-danger\" id=\"delBtn\"><i class=\"fa fa-trash\">删除</i></button>\r\n");
      out.write("                        <button type=\"button\" class=\"btn btn-primary\" id=\"markBtn\"><i class=\"fa fa-check\">标记为已完成</i></button>\r\n");
      out.write("                    </div>\r\n");
      out.write("                </div><!-- /.modal-content -->\r\n");
      out.write("            </div><!-- /.modal-dialog -->\r\n");
      out.write("        </div>\r\n");
      ...
      out.write("<script src=\"/static/plugins/fullcalendar/zh-cn.js\"></script>\r\n");
      ...
      out.write("                /*alert('Clicked on: ' + date.format());*///获取当前时间将其格式化\r\n");
      ...
      out.write("                //如何让标记为已经延期的事件在点击该事件是隐藏\r\n");
      out.write("                /*if(calEvent.done == 1){\r\n");
      out.write("                 $(\"#markBtn\")[0].hide();\r\n");
      out.write("                 }*/\r\n");
      out.write("\r\n");
      out.write("                $(\"#event_id\").val(calEvent.id);\r\n");
      out.write("                $(\"#event_title\").text(calEvent.title);\r\n");
      out.write("                $(\"#event_time\").text(moment(calEvent.start).format(\"YYYY-MM-DD\"));\r\n");
      out.write("                if (calEvent.end) {\r\n");
      out.write("                    $(\"#event_end_time\").text(moment(calEvent.end).format(\"YYYY-MM-DD\"));\r\n");
      out.write("                }\r\n");
      out.write("                else {\r\n");
      out.write("                    $(\"#event_end_time\").text(\"\");\r\n");
      out.write("                }\r\n");
      out.write("\r\n");
      out.write("                if (calEvent.remindtime) {\r\n");
      out.write("                    $(\"#event_remid\").text(calEvent.remindtime);\r\n");
      out.write("                } else {\r\n");
      out.write("                    $(\"#event_remid\").text(\"无\");\r\n");
      out.write("                }\r\n");
      out.write("                $(\"#taskModal\").modal({\r\n");
      out.write("                    show: true,\r\n");
      out.write("                    backdrop: 'static',\r\n");
      ...
      out.write("        });\r\n");
      out.write("        //修改已延期的事项\r\n");
      out.write("        $(document).delegate(\"#mark\", \"click\", function () {\r\n");
      out.write("            var id = $(this).val();\r\n");
      out.write("            $.get(\"/task/\" + id + \"/mark\").done(function (result) {\r\n");
      ...
      out.write("        });\r\n");
      out.write("        //删除已延期的事项\r\n");
      out.write("        $(document).delegate(\".todo-list > li\", \"click\", function () {\r\n");
      out.write("           var id =  $(\".todo-list > input\").val();\r\n");
      out.write("\r\n");
      out.write("            alert(id);\r\n");
      out.write("            $.get(\"/task/del/\" + id).done(function (data) {\r\n");
      out.write("                if(data == \"success\"){\r\n");
      out.write("                    alert(\"bbbbbbbbbbbbbbbbbbbbbbbbb\");\r\n");
      out.write("                    $calendar.fullCalendar('removeEvents',id);\r\n");
      out.write("                    $(\"#xxxx\").hide();\r\n");
      out.write("\r\n");
      out.write("                }\r\n");
      ...
      out.write("                $.get(\"/task/del/\" + _event.id).done(function (data) {\r\n");
      out.write("                    if (data == \"success\") {\r\n");
      out.write("                        $(\"#taskModal\").modal('hide');\r\n");
      out.write("                        $calendar.fullCalendar('removeEvents', _event.id);\r\n");
      out.write("                    }\r\n");
      out.write("                }).fail(function () {\r\n");
      out.write("                    alert(\"服务器异常\");\r\n");
      out.write("                });\r\n");
      ...
      out.write("            $.post(\"/task/\" + _event.id + \"/done\").done(function (data) {\r\n");
      out.write("                if (data == \"success\") {\r\n");
      ...
      out.write("        });\r\n");
      out.write("        //要在datepicker.js该源代码讲552行的10改为非常大的数。\r\n");
      ...
      out.write("            if (!$(\"#task_title\")) {\r\n");
      out.write("                $(\"#task_title\").onfocus();\r\n");
      out.write("                return;\r\n");
      out.write("            }\r\n");
  ...
  private boolean _jspx_meth_shir_005fprincipal_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/task/../include/mainHeader.jsp(125,48) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/task/list.jsp(60,32) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/task/list.jsp(60,32) '${taskList}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${taskList}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /WEB-INF/views/task/list.jsp(60,32) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
