    ...
    $(function(){
        ...
        $(document).delegate(".resetpwd","click",function(){
           ...
           if(confirm("确定将密码重置为000000？")){
               $.post("/admin/users/resetpwd",{"id":id}).done(function(data){
                   if(data == "success"){
                       alert("重置密码成功");
                   }
               }).fail(function(){
        ...
        $("#editForm").validate({
            ...
            submitHandler:function(form){
                $.post("/admin/user/edituser",$(form).serialize()).done(function(data){
                    if(data == "success"){
