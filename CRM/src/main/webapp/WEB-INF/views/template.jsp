    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="#"><i class="fa fa-link"></i> <span>公告</span></a></li>
                <li class="active"><a href="#"><i class="fa fa-link"></i> <span>项目管理</span></a></li>
                <li class="active"><a href="#"><i class="fa fa-link"></i> <span>客户管理</span></a></li>
                <li class="active"><a href="#"><i class="fa fa-link"></i> <span>统计</span></a></li>
                <li class="active"><a href="#"><i class="fa fa-link"></i> <span>待办事项</span></a></li>
                <li class="active"><a href="#"><i class="fa fa-link"></i> <span>文档管理</span></a></li>
                <li class="treeview">
